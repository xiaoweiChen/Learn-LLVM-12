...
编程语言通常支持接口，接口是虚拟方法的集合。接口很重要，因为它们添加了有用的抽象。我们将在下一节中讨论接口的可能实现。\par
