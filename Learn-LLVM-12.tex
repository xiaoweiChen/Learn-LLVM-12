...
\begin{document}
	...
	\subfile{content/2/chapter6/0.tex}
		...
		\subsubsection*{\zihao{3} 正确的获取二进制程序的接口}
	...
	%\subfile{content/1/chapter8/0.tex}
		...
		\subsubsection*{\zihao{3} 使用新的Pass管理器实现一个Pass}
		\addcontentsline{toc}{subsubsection}{使用新的Pass管理器实现一个Pass}
		%\subfile{content/1/chapter8/3.tex}
		\subsubsection*{\zihao{3} 使用旧的Pass管理器适配一个Pass}
		\addcontentsline{toc}{subsubsection}{使用旧的Pass管理器适配一个Pass}
